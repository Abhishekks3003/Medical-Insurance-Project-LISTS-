...
# Add your code here
total_cost=0
for actual_insurance_cost in actual_insurance_costs:
  total_cost+=actual_insurance_cost
...
updated_estimated_costs=[estimated_ins_cost*(11/10) for estimated_ins_cost in estimated_insurance_costs]
